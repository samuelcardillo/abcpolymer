...
(function(document) {
  ...
  var backendUrl = "http://127.0.0.1:1338"
  ...
  app.addEventListener('dom-change', function() {
    ...
    document.addEventListener('auth-form-sent',function(data){
      ...
      if(data.type === "login") {
        ironAjax.url = backendUrl + "/api/login";
        ...
        ironAjax.url = backendUrl + "/api/register";
        ironAjax.method = "POST"
        ...
        formInputs = formInputs + "pwd=" + data.formInputs.pwd + "&";
        formInputs = formInputs + "fullname=" + data.formInputs.fullname + "&";
        formInputs = formInputs + "token=" + app.logged.token;

        ironAjax.url = backendUrl + "/api/update";
        ironAjax.method = "POST"
        ironAjax.body = formInputs;
        ironAjax.generateRequest();
    ...
    app._logOutuser = function(){
      ironAjax.url = backendUrl + "/api/logout";
      ironAjax.method = "GET"
      ironAjax.generateRequest();
    }
    app.logged = false;
